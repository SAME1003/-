...
function initPage(pageId) {
  ...
  if (pageId === 'well') {
    ...
    if (GAME_STATE.discoveries.found_all_clues) {
      ...
      if (jb) jb.style.display = 'inline-block';
...
const newsData = [
  {
    ...
    date: '2024-03-15',
    source: '镇党政办',
    content: `<p>3月15日，景月镇2024年度经济工作会议在镇政府大礼堂召开。镇党委书记张文远讲话，镇长李建国主持。各村（社区）书记、镇属各部门负责人参加会议。</p>
    <p>会议通报了2023年全镇经济运行情况：全年实现地区生产总值18.6亿元，同比增长6.2%；农民人均可支配收入2.8万元。会议对2024年经济工作作了具体安排，涉及产业转型、乡村振兴、文旅项目推进、民生保障四个方面。</p>`
  },
  {
    title: '古镇景区上周接待游客8.2万人次',
    date: '2024-03-10',
    source: '镇旅游公司',
    content: `<p>据镇旅游公司统计，3月4日至10日，景月古镇景区接待游客8.2万人次，比去年同期增长23.5%。春季兰花展和夜游项目是主要增长点。</p>
    <p>景区管理处提醒，周末上午9点至11点为入园高峰，建议游客错峰出行。</p>`
  },
  {
    title: '我镇组织开展春季环境卫生集中整治',
    date: '2024-03-08',
    source: '镇爱卫办',
    content: `<p>3月7日，镇爱卫办组织机关干部、村社工作人员和志愿者约200人，对镇区主次干道、背街小巷、河道沿岸进行了集中清理。共清除卫生死角120余处，清运垃圾8车。</p>
    <p>下一步将重点整治井湾村北片区域的乱堆乱放问题。</p>`
  },
  {
    title: '镇中心小学开展传统文化体验活动',
    date: '2024-03-05',
    source: '镇教育办',
    content: `<p>3月4日至5日，镇中心小学邀请县文化馆的非遗传承人到校，给学生上了剪纸、竹编、糖画等体验课。活动覆盖全校6个年级共420名学生。</p>`
  },
  {
    title: '景月湖水质提升工程进展通报',
    date: '2024-02-28',
    source: '镇农业农村办',
    content: `<p>景月湖水质提升工程自2023年8月开工，目前环湖污水管网改造完成75%，底泥清淤完成60%。工程预计2024年6月底完工。</p>
    <p>施工期间，景月湖东岸步道部分路段封闭，请绕行。</p>
    <p class="strikethrough">（注：2003年洪涝灾害后，景月湖水系曾出现异常情况，经综合治理后恢复正常。历史档案编号：JYZ-2003-SW-0714）</p>`
  },
  {
    title: '李建国镇长带队检查企业安全生产',
    date: '2024-02-20',
    source: '镇应急管理办',
    content: `<p>2月20日下午，镇长李建国带队检查了景月酿造厂、恒达竹制品厂等4家企业的安全生产情况，重点查看了消防通道、用电线路和仓库管理。对3家企业下达了限期整改通知书。</p>`
  },
  {
    title: '我镇举办春季招聘会 32家企业提供680个岗位',
    date: '2024-02-15',
    source: '镇社保办',
    content: `<p>2月15日，2024年"春风行动"招聘会在镇文化广场举行。32家企业到场，提供岗位680余个，主要集中在制造业、餐饮服务和旅游行业。当天初步达成就业意向186人。</p>`
  },
  {
    title: '我镇入选首批省级全域旅游示范镇',
    date: '2024-01-28',
    source: '镇文旅办',
    content: `<p>省文旅厅近日公布首批省级全域旅游示范镇名单，景月镇在列。2023年全镇接待游客126万人次，旅游综合收入8.2亿元。</p>`
  },
];
...
// ========== 画廊数据 ==========
const galleryData = [
  { title: '月牙桥 · 晨雾', image: 'jingyue_images/02_moon_bridge.jpg', desc: '月牙桥建于明代，是古镇保存最完好的石拱桥。桥面石板被踩得发亮，早上雾大的时候桥洞底下看不太清。' },
  { title: '古戏台 · 春秋', image: 'jingyue_images/06_ancient_stage.jpg', desc: '古戏台建于清乾隆年间，木结构，顶上的彩绘还剩一些。逢年过节会请戏班来唱戏，平时锁着。' },
  { title: '景月湖 · 夕照', image: 'jingyue_images/05_lake_sunset.jpg', desc: '景月湖面积约1.8万亩，因湖形弯曲得名。傍晚在东岸看日落角度最好，夏天湖边蚊子多，注意防蚊。' },
  { title: '古镇全景 · 晨雾', image: 'jingyue_images/01_town_panorama.jpg', desc: '古镇核心区沿河而建，保留明清建筑约47处。早上6点到8点雾最大，拍照的人比较多。' },
  { title: '民国老街 · 旧影', image: 'jingyue_images/04_old_photo.jpg', desc: '这张照片大约拍摄于1935年前后，石板街当时是镇上最热闹的地方。右边那家布店后来改成了供销社。' },
  { title: '北井 · 千年古井', image: 'jingyue_images/03_north_well.jpg', desc: '北井位于井湾村北，具体建造年代不详。井圈是青石的，井水常年不干。2003年后井口加了围栏，不允许靠近。' },
